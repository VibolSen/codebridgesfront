    ...
    <div className="p-8 space-y-6 max-w-7xl mx-auto font-sans text-slate-800">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">Issue official purchase orders to suppliers and track delivery status</p>
        </div>
      </div>
          ...
          <tbody className="divide-y divide-slate-100">
            {loading ? (
              ...
              <tr key={po.id} className="hover:bg-slate-50/50">
                ...
                <td className="py-3.5 px-4 font-mono font-black text-indigo-600 text-sm">${Number(po.est_total).toFixed(2)}</td>

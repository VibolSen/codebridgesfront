    ...
    <div className="p-8 space-y-6 max-w-7xl mx-auto font-sans text-slate-800">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">Manage vendor stock receiving bills, cost invoices, and inventory replenishment records</p>
        </div>
      </div>
          ...
          <tbody className="divide-y divide-slate-100">
            {loading ? (
              ...
              <tr key={p.id} className="hover:bg-slate-50/50">
                ...
                <td className="py-3.5 px-4 font-mono font-black text-blue-600 text-sm">${Number(p.total_amount).toFixed(2)}</td>

...
import { Printer, Barcode, Search, Plus, Trash2, CheckCircle2, RefreshCw } from 'lucide-react';
...
export default function AdminBarcodesPage() {
  ...
  const [labelSize, setLabelSize] = useState('38x25'); // 38x25, 50x30
    ...
    <div className="p-8 space-y-6 max-w-7xl mx-auto font-sans text-slate-800">
      ...
      <div className="flex items-center justify-between print:hidden">
        ...
        <button
          ...
          className="px-5 py-2.5 rounded-xl bg-orange-500 hover:bg-orange-600 active:bg-orange-700 text-white font-bold text-xs shadow-md shadow-orange-500/20 transition-all flex items-center gap-2 disabled:opacity-50"
        >
              ...
              filteredProducts.map((p) => (
                <div key={p.id} className="pt-1.5 flex items-center justify-between text-xs">
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-lg bg-orange-50 text-orange-600 hover:bg-orange-500 hover:text-white transition-colors"
                  >
          ...
          <div className="space-y-3 text-xs">
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 rounded-xl bg-slate-100 border border-slate-200 font-semibold text-slate-900"
              >
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-xs space-y-4">
        <h3 className="font-bold text-sm text-slate-900 uppercase tracking-wider print:hidden">Sticker Sheet Live Preview</h3>

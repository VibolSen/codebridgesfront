...
import { LayoutGrid, RefreshCw, CheckCircle2, UserCheck, Clock, Plus } from 'lucide-react';
    ...
    <div className="p-8 space-y-6 max-w-7xl mx-auto font-sans text-slate-800">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={loadTables}
          disabled={loading}
          className="px-4 py-2.5 rounded-xl bg-slate-900 hover:bg-black text-white font-bold text-xs shadow-md transition-all flex items-center gap-2"
        >
            ...
            >
              ...
              <div className="pt-2 border-t border-slate-200/60 flex items-center gap-1.5 text-[11px]">
                <button
                  ...
                  className="flex-1 py-1.5 rounded-lg bg-emerald-600 text-white font-bold hover:bg-emerald-700"
                >
                  Vacant
                </button>
                <button
                  onClick={() => handleStatusChange(t.id, 'occupied')}
                  className="flex-1 py-1.5 rounded-lg bg-rose-600 text-white font-bold hover:bg-rose-700"
                >
                  Occupied
                </button>
                <button
                  onClick={() => handleStatusChange(t.id, 'bill_requested')}
                  className="flex-1 py-1.5 rounded-lg bg-amber-500 text-white font-bold hover:bg-amber-600"
                >
                  Bill
                </button>
              </div>

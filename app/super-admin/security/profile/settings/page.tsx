  ...
  return (
    <div className="p-8 space-y-6 max-w-4xl mx-auto font-sans text-slate-800">
      <div>
        ...
        <p className="text-xs text-slate-500 mt-1">Update display name, contact email, and account login password</p>
      </div>
      ...
      <form onSubmit={handleSave} className="bg-white border border-slate-200 rounded-3xl p-8 shadow-xs space-y-6">
        <div className="space-y-4 text-xs">
          <h2 className="text-sm font-extrabold text-slate-900 uppercase tracking-wider text-slate-400">Personal Details</h2>
        ...
        <div className="border-t border-slate-100 pt-6 space-y-4 text-xs">
          <h2 className="text-sm font-extrabold text-slate-900 uppercase tracking-wider text-slate-400">Security & Password</h2>
        ...
        <div className="pt-4 flex justify-end">
          <button
            type="submit"
            className="px-6 py-3 bg-orange-500 hover:bg-orange-600 font-bold text-xs text-white rounded-xl shadow-md transition-all flex items-center gap-2"
          >

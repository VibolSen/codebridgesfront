...
export function SuperAdminQrCodesView() {
  ...
  return (
    <div className="p-8 space-y-6 max-w-5xl mx-auto font-sans text-slate-800">
      ...
      <div className="flex items-center justify-between print:hidden">
        ...
        <button
          onClick={handlePrint}
          className="px-5 py-2.5 rounded-xl bg-red-600 hover:bg-red-700 active:bg-red-800 text-white font-bold text-xs shadow-md transition-all flex items-center gap-2 cursor-pointer"
        >

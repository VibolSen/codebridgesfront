      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-3xl border border-slate-200 shadow-2xs">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <button
            ...
            className="px-4 py-2.5 rounded-xl bg-orange-600 hover:bg-orange-700 text-white font-extrabold text-xs shadow-md shadow-orange-600/20 flex items-center gap-2 transition-all cursor-pointer"
          >
          ...
          <form onSubmit={onSearchSubmit} className="flex-1 min-w-[280px]">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2 rounded-xl bg-slate-50 border border-slate-200 text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-orange-500 font-medium"
              />
            </div>
          </form>

    ...
    <div className="bg-white p-5 rounded-2xl border border-slate-200/90 shadow-xs space-y-3">
      <div className="flex items-center justify-between pb-3 border-b border-slate-100">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-xl bg-purple-100 text-[#5B4DFB] flex items-center justify-center">
        ...
        <span className="px-2 py-0.5 rounded-full text-[10px] font-extrabold bg-purple-50 text-[#5B4DFB] border border-purple-200">
            ...
            <div key={po.id} className="py-3 first:pt-0 last:pb-0 flex items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-3 shrink-0">
                ...
                <Link
                  ...
                  className="px-3 py-1.5 rounded-xl bg-slate-100 hover:bg-purple-100 hover:text-[#5B4DFB] font-bold text-xs transition-colors"

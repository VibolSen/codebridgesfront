    ...
    <div className="space-y-4">
      ...
      <div className="space-y-1.5">
        ...
        <input
          ...
          className="w-full px-4 py-2.5 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-xs font-semibold text-slate-900 bg-slate-50/50 placeholder:text-slate-400"
        />
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <select
          ...
          className="w-full px-4 py-2.5 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-xs font-semibold text-slate-800 bg-slate-50/50"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
        <div className="space-y-1">
          ...
          <input
            ...
            className="w-full px-3 py-2 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-orange-500 text-xs font-medium text-slate-800 bg-slate-50/50"
          />
        </div>
        <div className="space-y-1">
          <label className="text-[11px] font-bold text-slate-500 flex items-center gap-1">

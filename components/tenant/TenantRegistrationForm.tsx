    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <button
          ...
          className="text-xs font-bold text-slate-500 hover:text-brand flex items-center gap-1.5 transition-colors cursor-pointer bg-white border border-slate-200 px-3.5 py-1.5 rounded-xl shadow-2xs"
        >
      ...
      {/* Main Form Container */}
      <div className="bg-white rounded-3xl border border-slate-200/80 shadow-2xl shadow-brand/5 p-6 sm:p-8 space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-5">
          <div className="space-y-1">
            ...
            <p className="text-xs font-medium text-slate-500">
              Selected Plan: <span className="text-brand font-extrabold">{selectedPlan.label}</span> (14-Day Trial Included)
            </p>
          </div>
        ...
        <form onSubmit={onSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl bg-white border border-slate-200 text-slate-900 placeholder-slate-400 text-xs focus:outline-none focus:ring-2 focus:ring-brand/30 focus:border-brand transition-all"
                />
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl bg-white border border-slate-200 text-slate-900 text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-brand/30 focus:border-brand transition-all"
                >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl bg-white border border-slate-200 text-slate-900 placeholder-slate-400 text-xs focus:outline-none focus:ring-2 focus:ring-brand/30 focus:border-brand transition-all font-mono"
                  />
                </div>
                <div>
          ...
          <motion.button
            ...
            type="submit"
            disabled={loading}
            className={`w-full py-3.5 rounded-2xl font-black text-xs text-white shadow-xl shadow-brand/20 bg-gradient-to-r ${selectedPlan.gradient} hover:opacity-95 transition-all flex items-center justify-center gap-2 cursor-pointer`}
          >
            {loading ? (
